...
void SSL_WrapperPacket::SerializeWithCachedSizes(
  ...
  // optional .SSL_DetectionFrame detection = 1;
  if (_has_bit(0)) {
    ::google::protobuf::internal::WireFormat::WriteMessageNoVirtual(1, this->detection(), output);
  }
  
  // optional .SSL_GeometryData geometry = 2;
  if (_has_bit(1)) {
    ::google::protobuf::internal::WireFormat::WriteMessageNoVirtual(2, this->geometry(), output);
  }
...
::google::protobuf::uint8* SSL_WrapperPacket::SerializeWithCachedSizesToArray(
  ...
  // optional .SSL_DetectionFrame detection = 1;
  if (_has_bit(0)) {
    target = ::google::protobuf::internal::WireFormat::WriteMessageNoVirtualToArray(1, this->detection(), target);
  }
  
  // optional .SSL_GeometryData geometry = 2;
  if (_has_bit(1)) {
    target = ::google::protobuf::internal::WireFormat::WriteMessageNoVirtualToArray(2, this->geometry(), target);
  }
