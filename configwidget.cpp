...
{  
  ...
  world.push_back(geo_vars);
    ...
    geo_vars->addChild(robotg_vars);
        ADD_VALUE(robotg_vars,Double,CHASSISLENGTH,0.153,"Chassis length")
        ADD_VALUE(robotg_vars,Double,CHASSISWIDTH,0.146,"Chassis width")
  ...
  world.push_back(phys_vars);
    ...
    phys_vars->addChild(robotp_vars);
        ...
        ADD_VALUE(robotp_vars,Double,KICKFACTOR,1.0f,"Kick factor")
        ADD_VALUE(robotp_vars,Double,CHIPFACTOR,1.0f,"Chip kick factor")
        ADD_VALUE(robotp_vars,Double,ROLLERTORQUEFACTOR,0.015f,"Roller torque factor")
